...
def generate_all_ps_combinations():
    ...
    metrics_combinations = [
        ...
        "variance", 
        "estimated_atomicity",
        "variance estimated_atomicity", 
        "simplicity variance", 
        "simplicity variance estimated_atomicity",
        "simplicity estimated_atomicity",
    ]
...
def generate_specific_missing():
    """Generate only specific missing combinations from your original list"""
...
def generate_reduced_test_set():
    """Generate a smaller test set for debugging"""
